...
public class CellView : MonoBehaviour
{
    ...
    //    this.letterText = cellPrefab.GetComponent<CellView>.GetComponentInChildren<TextMeshProUGUI>();
    //    this.sprite = cellPrefab.GetComponentInChildren<Sprite>();
    ...
    public void Initialize(CellModel cell, GameObject cellPrefab, Transform parent)
    {
        this.cellModel = cell;
        this.letterText.text = cell.CurrentLetter;
