...
namespace Assets.Scripts.Data
{
    public abstract class Language
    {
        ...
        public abstract string GetGameModeText(GameType gameMode);
    ...
    public class SpanishLang : Language
    {
        ...
        public override string GetGameModeText(GameType gameMode)
        {
            switch (gameMode)
            {
                case GameType.CatchLetter:
                    return "Atrapa la letra!";
                case GameType.PointsChallenge:
                    return "Desafío de puntos!";
                case GameType.NLetterWordChallenge:
                    return "Desafío de palabras!";
                case GameType.NLetterChallenge:
                    return "Desafío de letras!";
                case GameType.HiddenWord:
